# -*- encoding: utf-8 -*-
# stub: logstash-input-http_poller 2.0.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<logstash-mixin-http_client>, ["< 3.0.0", ">= 2.1.0"])
      ...
      s.add_dependency(%q<logstash-mixin-http_client>, ["< 3.0.0", ">= 2.1.0"])
