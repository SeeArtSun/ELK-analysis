# -*- encoding: utf-8 -*-
# stub: jruby-kafka 1.5.0 java lib
...
Gem::Specification.new do |s|
  ...
  s.requirements = ["jar 'org.apache.kafka:kafka_2.10', '0.8.2.2'", "jar 'org.slf4j:slf4j-log4j12', '1.7.13'"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<ruby-maven>, ["~> 3.3.8"])
      s.add_development_dependency(%q<rake>, ["~> 10.4"])
    else
      s.add_dependency(%q<jar-dependencies>, ["~> 0"])
      s.add_dependency(%q<ruby-maven>, ["~> 3.3.8"])
